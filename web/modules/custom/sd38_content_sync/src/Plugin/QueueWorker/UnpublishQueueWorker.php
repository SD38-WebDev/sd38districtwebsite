...
/**
 * Unpublish Queue Worker.
 *
 * @QueueWorker(
 *   id = "unpublish_queue_worker",
 *   title = @Translation("Unpublish Queue Worker"),
 *   cron = {"time" = 60}
 * )
 */
class UnpublishQueueWorker extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    if (array_key_exists($data['school'], $schools)) {
      ...
      try {
        $url = 'https://' . $schoolDomain . '/api/district-unpublish';
